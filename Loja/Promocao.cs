...
namespace Loja
{
    public class Promocao
    {
        ...
        public List<PromocaoProduto> Produtos { get; internal set; } // Uma promoção contém vários produtos e um produto contém várias promoções, o que contituí uma relação de muitos para muitos
